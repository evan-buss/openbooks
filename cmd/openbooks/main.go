...
func init() {
	...
	desktopCmd.PersistentFlags().StringVarP(&globalFlags.UserAgent, "useragent", "u", fmt.Sprintf("OpenBooks Server %s", ircVersion), "UserAgent / Version Reported to IRC Server.")
